...
<body>
		...
		<!-- SUBCABECALHO DA PAGINA -->
			<div class = areaH1>
				<div class = "h1">Relação de Membros Desativados</div>
				<div class = "h2">Nessa sessão é possível visualizar os Membros excluidos</div>
			</div>
		<!-- ---------------------- -->
		...
		<div class = "conteudo">
				...
				<!-- Listar Clientes -->
				<br>
				<legend>Relação de Membros</legend>
				
				<?php include "listaFuncD2.php";?>
