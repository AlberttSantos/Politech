...
<body>
		...
		<!-- SUBCABECALHO DA PAGINA -->
			<div class = areaH1>
				<div class = "h1">Relação de Projetos Desativados</div>
				<div class = "h2">Nessa sessão é possível visualizar os Projetos excluidos</div>
			</div>
		<!-- ---------------------- -->
		...
		<div class = "conteudo">
				...
				<!-- Listar Clientes -->
				<br>
				<legend>Relação de Projetos</legend>
				
				<?php include "listarProjD2.php";?>
