...
<html>
	<head>
		<title>Politech - Professores Orientadores</title>
		<meta charset="utf-8" />
...
<body>
		...
		<!-- SUBCABECALHO DA PAGINA -->
			<div class = areaH1>
				<div class = "h1">Relação de Professores Desativados</div>
				<div class = "h2">Nessa sessão é possível visualizar os Professores Orientadores excluidas</div>
			</div>
		<!-- ---------------------- -->
			</br>
		<div class = "conteudo">
				...
				<?php include "listaProfessorD2.php";?>
