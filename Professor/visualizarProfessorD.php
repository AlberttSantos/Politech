...
<?php if ($nivel >= '4'){ ?>
	...
	<div class = "areaCadastro">
		...
		<!-- SUBCABECALHO DA PAGINA -->
			<div class = areaH1>
				<div class = "h1">Dados do Professor Desativado</div>
		...
		<div class = "conteudo">
			<form method = "post" action = "editarProfessor2.php" name="CadastroProfessor" class = "form-horizontal">
		  	...
		  	<!-- AREA DADOS PESSOAIS ------------------------------------->	
					...
					<?php
					  ...
					  // $busca2 = mysql_query("SELECT * FROM cadastroProj WHERE CDPROF = $cdProfessor");
					...
					<!-- Linha 1 -->
						<div class="row-fluid">
							<div class="span10">
							<div class = "textovisualizacao"><b>Nome do Professor: </b><?php echo $row[1]; ?></div>
						...
						<div class="row-fluid">
							<div class="span10">
							<div class = "textovisualizacao"><b>E-mail do Professor: </b><?php echo $row[17]; ?></div>
							</div><!-- /Campo 1 -->
						</div><p>
				...
				<!-- Linha 4 -->
						...
						<!-- BOTÕES -->
					<input type="button" value="Voltar" name="btnVoltar" class = "btn" onclick="location.href = 'listaProfessorD.php'">
