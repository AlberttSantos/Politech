	...
	<div class = "areaCadastro">
		...
		<!-- SUBCABECALHO DA PAGINA -->
			<div class = areaH1>
				...
				<div class = "h2">Nessa sessão é possível editar os dados de Pessoa Física</div>
			</div>
		<!-- ---------------------- -->
			</br>
			...
			<form method = "post" action = "editarCliente2.php" name="CadastroCliente" class = "form-horizontal">
		  	...
		  	<!-- AREA DADOS PESSOAIS ------------------------------------->	
					...
					<!-- Linha 1 -->
						<div class="row-fluid">
						   ...
						   <div class="span3">
								...
								<label>E-mail</label>
									<input type = "text" value="<?php echo $row[17]; ?>" name = "txtEmail" id="inputIcon" class = "input-xxlarge" placeholder = "example@dominio.com.br" onBlur = "verificaEmail()" required/>
					...
					<!-- Linha 2 -->
						...
						<div class="span2">
								<label>CPF</label>
								<input type = "text" id = "cpf" value="<?php echo $row[2]; ?>" name = "txtCPF" onBlur="ValidarCPF(CadastroCliente.cpf);" onKeyPress="MascaraCPF(CadastroCliente.cpf);" maxlength="14" class="span11" placeholder = "000.000.000-00" required/>
								<div id="msg7" class = "msg"></div>
						</div><!-- /Campo 1 -->
						<div class="span2">
								<label>Profissão</label>
								<input type = "text" name = "txtProfissao" class = "span12" value="<?php echo $row[3]; ?>" required/>
						</div><!-- /Campo 2 -->
						<div class="span2">
								<label>Sexo</label>
								<select name = "cbSexo" style = "width: 142px;">
											<option value = "M" <?php if($row[6] == 'M') echo 'selected="selected"'; ?>>Masculino</option>
											<option value = "F" <?php if($row[6] == 'F') echo 'selected="selected"'; ?>>Feminino</option>
								</select>
						</div><!-- /Campo 2 -->
					...
					<div class="row-fluid">
							<div class="span3">
								...
								<textarea rows="2" name = "txtCDesc" class = "input-xxlarge" id = "CDesc" maxlength = "100"><?php echo $row[4]; ?></textarea>
							</div>
						</div><br>
				...
				<div class="row-fluid">
					<div class="span6">
						...
						<input type = "text" value ="<?php echo $row[9]; ?>" onkeypress= "MascaraCep(CadastroCliente.cep);" id = "cep" name ="txtCep"  maxlength="10" placeholder = "00000-000"required/>&nbsp;&nbsp;&nbsp;<a href =http://www.buscacep.correios.com.br/sistemas/buscacep/ target="_blank">Não sei meu CEP</a>
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<input type = "text" id = "rua" name = "txtRua" value="<?php echo $row[10]; ?>"  class = "input-xxlarge" required/>
					</div>
                </div><p> 
				<!-- FIM LINHA 2 -->
				...
				<div class="row-fluid">
					<div class="span2">
						<label>Número</label>
						<input type = "text" onBlur="somenteNumeros(CadastroCliente.num);" maxlength="7" id="num" name = "txtNumero" value="<?php echo $row[11]; ?>"  class = "span10" required/>
				...
				<!-- Linha 4 -->
						...
						<legend>Contato</legend>
							<div class="row-fluid">
								<div class="span3">
									...
									<input type = "text" value="<?php echo $row[7]; ?>" name = "txtTelefone" id = "tel" onBlur="ValidaTelefone(CadastroCliente.tel);" onKeyPress="MascaraTelefone(CadastroCliente.tel);" maxlength = "14" class = "span11" placeholder = "(00)0000-0000" id="campoTelefone" /required>
									<div id="msg6" class = "msg"></div>
								</div>
								<div class="span3">
									<label>Celular</label>
										<input type = "text" value="<?php echo $row[8]; ?>" name = "txtCelular" id = "cel" onBlur="ValidaCelular(CadastroCliente.cel);" onKeyPress="MascaraCelular(CadastroCliente.cel);" maxlength = "15" class = "span11" placeholder = "(00)00000-0000" id="campoCelular" /required>
										<div id="msg7" class = "msg"></div>
								</div>
							</div>
						<!-- FIM LINHA 1 -->
						...
						<div class="row-fluid">
							<div class="span3">
								<textarea rows="3" name = "txtObs" class = "input-xxlarge" id = "Obs" maxlength = "200"><?php echo $row[5]; ?></textarea>
							</div>
						</div><br>
						</div>
						...
						<!-- BOTÕES -->
							...
							<input type="button" value="Cancelar" name="btnVoltar" class = "btn btn-danger" onclick="location.href = 'listaCliente.php'">
