...
$cont = 0;	
	...
	$resultado = mysql_query("select * from cliente WHERE STATUS = 'D'");
	...
	else
	{
		...
		while($linha = mysql_fetch_array($resultado))
		{
			...
			echo "<td><a href='visualizarClienteD.php?cdCliente={$linha[0]}'><i class='icon-search'></i></a></td>";
			echo "</tr>";
			$cont++;
		}
		echo "</table>";
...
<div id="modal-from-dom" class="modal hide fade">
    ...
    <div class="modal-footer">
        <a href="ativarCliente.php?cdCliente=" class="btn danger">Sim</a>
